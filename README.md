...
- **抖音包装**（默认开启）：成片自动变 1080×1920 竖屏（模糊背景填充）+ AI 起爆款标题压顶部 + 逐句大字幕 + 金句关键词高亮（抖音黄）+ 响度标准化
...
```
douyin_*.mp4               抖音成片（竖屏+标题+字幕，直接发布）
clip_*.mp4 / short_*.mp4   原比例成片
